...
An out of source build is the recommended way of building *IdLib Text*.

- Checkout `idlib-text` [https://github.com/michaelheilmann/idlib-text.git](https://github.com/michaelheilmann/idlib-text.git) into a directory in your file system.
...
The above builds *IdLib Text* without debug information. To build *IdLib Text* with debug information add the parameter `-DCMAKE_BUILD_TYPE="Debug"` to the cmake command.
